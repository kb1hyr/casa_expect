 ...
 * 
 * Original github source here: https://github.com/ronniedong/Expect-for-Java
 * 
 * @author Ronnie Dong, updated by Brett Markham  
 * @version 1.2
 */
public class Expect {
	//static final Logger log = Logger.getLogger(Expect.class);
	public static final Logger log = org.apache.logging.log4j.LogManager.getLogger(Expect.class);
